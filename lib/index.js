...
var AutoLinkText = (function (_React$Component) {
  ...
  _createClass(AutoLinkText, [{
    ...
    value: function render() {
      ...
      var target = this.props.target || '_blank';
      var rel = this.props.rel || 'noreferrer noopener';

      return _react2['default'].createElement(
        'span',
        null,
        (_context = (_context = (_context = (0, _match_parser2['default'])(text), prepareElements).call(_context, text, target, rel), truncate).call(_context, this.props.maxLength), keyElements).call(_context)
      );
    }
  }]);
...
function prepareElements(text, target, rel) {
  ...
  this.forEach(function (match) {
    ...
    elements.push(_react2['default'].createElement(
      'a',
      { target: target, rel: rel, href: match.getAnchorHref() },
      match.getAnchorText()
    ));
